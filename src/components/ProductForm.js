  ...
  function createProductCallback() {
    ...
    createProduct().catch(e => {
      ...
      <div className={classes.paper}>
        ...
        <InputLabel className=".select-label" id="demo-simple-select-helper-label">Категорија</InputLabel>
          <Select
          className="select-field"
          name="category"
          fullWidth
...
const CREATE_PRODUCT_MUTATION = gql`
  mutation createProduct($title: String!, $description:String!, $location:String!, $image:String! $category:String! $region:String! $creator:String!) {
    createProduct(title: $title,description:$description,location:$location,image:$image,category:$category region:$region creator:$creator) {
      title
      description
      createdAt
      category
