...
const useStyles = makeStyles((theme) => ({
  ...
  hero: {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('https://images.pexels.com/photos/4194610/pexels-photo-4194610.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')`,
    height: "500px",
